export default {
  ...
  properties: {
    ...
    deliveryPostcode: {
      label: { en: 'Delivery Postcode (auto-fills for members)' },
      type: 'Text',
      bindable: true,
      defaultValue: '',
      /* wwEditor:start */
    ...
    regionId: {
      label: { en: 'Region ID (legacy / override)' },
      type: 'Text',
      bindable: true,
      defaultValue: '',
      /* wwEditor:start */
    ...
    requireRegion: {
      label: { en: 'Require Delivery Area' },
      type: 'OnOff',
      defaultValue: true,
    },
    heading: {
  ...
  triggerEvents: [
    ...
    },
    {
      ...
      label: { en: 'On Region Resolved' },
      event: { postcode: '', regionId: '', regionName: '', stateName: '' },
    },
    {
      name: 'catalog:error',
      label: { en: 'On Error' },
